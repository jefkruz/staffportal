                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($programmes as $i => $fam)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($fam->accessibility == 'heads')
                                             Departmental Heads
                                            @elseif ($fam->accessibility == 'all')
                                                Every Staff Member
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="  {{route('meetings.manage',$fam->id)}}" class="btn  btn-sm btn-primary mt-1">
                                                   @if($fam->meeting_count )
                                                   {{$fam->meeting_count}}
                                                   @else
                                                    {{ $fam->getAttendanceCount() }}
                                                   @endif
                                                    <i class="fas fa-users"></i></a>

                                            <a href="{{route('meetings.edit', $fam->id)}}" class="btn btn-sm mt-2 btn-success"><i class="fa fa-edit"></i> Edit</a>
