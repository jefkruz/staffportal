        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 p-2">
                    <div class="card">
                        <h2 class="card-header">Happy Birthday!</h2>

                        <img src="{{url($staff->picturePath ?? '') }}" class="img-thumbnail"  alt="">
                        <div class="card-body">
                            <h6 class="card-title">{{ ucwords($staff->fullname()) }}</h6>
                            <h6 class="card-subtitle mb-2 text-muted">{{ $staff->department->deptName}}</h6>
